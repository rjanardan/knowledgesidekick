/* ============================================================
   knowledgesidekick.com — shared nav builder
...
(() => {
  ...
  // ---- nav data: one place to add future tabs/groups ----
  const NAV = {
    logoHref: '/',
    logoSvg: 'logo.svg',
    ...
    groups: [
      ...
      },
      {
        ...
        open: true,
        items: [
          { label: 'Agentic AI', href: '/agentic-ai.html', local: true },
          { label: 'A2A Communication', href: '/a2a.html', local: true },
      ...
      },
      {
        ...
        open: false,
        items: [
          { label: 'Overview', href: '/personal-assistants.html', local: true },
          { label: 'Memory', href: '/personal-memory.html', local: true },
          {
            label: 'Privacy, Control & Compliance',
            href: '/personal-privacy.html',
            local: true
          }
        ]
      },
      {
        ...
        items: [
          ...
          { label: 'Knowledge Maturity Evaluation', href: '/offering-maturity.html', local: true },
      ...
      },
      {
        ...
        open: false,
        items: [
          { label: 'Org', href: 'https://knowledgesidekick.org', local: false, target: '_blank' },
          {
            label: 'Community',
